...
public static class TextBoxNumericInputHelper
{
    //textbox-to-only-accept-numeric-input-in-wpf - Amir Mahdi Nassiri
    ...
    public static readonly DependencyProperty OnlyNumericProperty =
        DependencyProperty.RegisterAttached("OnlyNumeric", typeof(NumericFormat?), typeof(TextBoxNumericInputHelper),
    ...
    public static readonly DependencyProperty DefaultValueProperty =
        DependencyProperty.RegisterAttached("DefaultValue", typeof(string), typeof(TextBoxNumericInputHelper),
            new PropertyMetadata(null, DependencyPropertiesChanged));
    ...
    public static readonly DependencyProperty EvenOddConstraintProperty =
        DependencyProperty.RegisterAttached("EvenOddConstraint", typeof(EvenOddConstraint),
            typeof(TextBoxNumericInputHelper),
