...
public static class S3Tools
{
    ...
    /// <summary>
    ///     Creates and S3 TransferUtilityUploadRequest based on a FilePath
    /// </summary>
    /// <param name="toUpload"></param>
    /// <param name="bucket"></param>
    /// <param name="key"></param>
    /// <returns></returns>
    public static async Task<TransferUtilityUploadRequest> S3TransferUploadRequestFilePath(FileInfo toUpload,
        string bucket,
        string key)
    {
    ...
    /// <summary>
    ///     Creates and S3 TransferUtilityUploadRequest with a FileStream - this may help with files that are
    ///     in use.
    /// </summary>
    /// <param name="toUpload"></param>
    /// <param name="bucket"></param>
    /// <param name="key"></param>
    /// <returns></returns>
    public static async Task<TransferUtilityUploadRequest> S3TransferUploadRequestFileStream(FileInfo toUpload,
        string bucket, string key)
    {
        var fileStream = new FileStream(toUpload.FullName, FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
