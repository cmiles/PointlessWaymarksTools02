...
public class ConversionDataEntryContext<T> : INotifyPropertyChanged, IHasChanges, IHasValidationIssues, IConversionDataEntryContext
{
    ...
    private string _referenceValueString;
    ...
    public T? ReferenceValue
    {
        ...
        set
        {
            ...
            ReferenceValueString = value?.ToString() ?? string.Empty;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => _referenceValueString;
        set
        {
            if (value == _referenceValueString) return;
            _referenceValueString = value;
            OnPropertyChanged();
        }
    }
